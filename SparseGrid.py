# This is a modified python version of jgarke's script, accessible here:
# https://github.com/jgarcke/sparse-grid-py
#
# ----------------------------------------------------------------
#
...
class sparseGrid: 
  ...
  def __init__(self,dim=1,level=1):
    ...
    self.domain = ((0.0,1.0),)*dim #so for dim = 3 it'd look like: 
  ...
  def evalFunct(self,x):
    """ evaluate a sparse grid function, hierarchical values have to be set """
    self.value = 0.0
    self.evalPerDim = []
