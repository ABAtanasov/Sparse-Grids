...
(*The area weights, although they sum to 1, are not totally right for sparse grids. The right weights 
can be obtained by applying sparseIntegrateByCoefficients to the lagrange position functions*)
